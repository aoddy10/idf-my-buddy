...
from app.schemas.common import (
    BaseResponse, LanguageCode, DietaryRestriction, 
    AccessibilityNeed, Coordinates
)
...
class UserRegistrationRequest(BaseModel):
    ...
    home_country: Optional[str] = Field(None, max_length=100, description="Home country")
    home_city: Optional[str] = Field(None, max_length=100, description="Home city")
...
class UserProfileResponse(BaseModel):
    ...
    home_country: Optional[str] = Field(None, description="Home country")
...
class UserProfileUpdateRequest(BaseModel):
    ...
    preferred_language: Optional[LanguageCode] = Field(None, description="Preferred language")
    secondary_languages: Optional[List[LanguageCode]] = Field(None, description="Secondary languages")
    ...
    accessibility_needs: Optional[List[AccessibilityNeed]] = Field(None, description="Accessibility needs")
...
class UserPreferencesResponse(BaseModel):
    ...
    # Travel preferences
    travel_style: Optional[str] = Field(None, description="Travel style")
    budget_preference: Optional[str] = Field(None, description="Budget preference")
...
class UserSessionInfo(BaseModel):
    ...
    # Location context
    current_location: Optional[Coordinates] = Field(None, description="Current location")
    current_city: Optional[str] = Field(None, description="Current city")
    current_country: Optional[str] = Field(None, description="Current country")
