...
class ModelProfiler(LoggerMixin):
    ...
    def get_profile_results(self, profile_id: str) -> dict[str, Any] | None:
...
class PerformanceMonitor(LoggerMixin):
    ...
    def get_inference_stats(self, model_name: str | None = None) -> dict[str, Any]:
    ...
    def save_report(self, filepath: str | Path, include_system: bool = True):
...
def performance_monitor(monitor_instance: PerformanceMonitor | None = None):
