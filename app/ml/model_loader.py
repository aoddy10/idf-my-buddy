...
class BaseModelLoader(ABC, LoggerMixin):
    ...
    @abstractmethod
    async def load_model(self, model_path: str | Path, **kwargs) -> Any:
    ...
    def _generate_cache_key(self, model_path: str | Path, **kwargs) -> str:
...
class TorchModelLoader(BaseModelLoader):
    ...
    def _load_torch_model_sync(self, model_path: str | Path, device: str, kwargs: dict) -> Any:
...
class ModelLoader(LoggerMixin):
    ...
    def _detect_model_format(self, model_path_or_name: str | Path) -> str:
    ...
    def get_model_info(self, model: Any, model_format: str | None = None) -> dict[str, Any]:
        """Get model information."""
