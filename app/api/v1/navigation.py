...
from app.core.deps import (
    get_db_session, get_current_user_optional, get_maps_service,
    validate_coordinates
)
from app.core.logging import LoggerMixin
from app.models.entities.user import User
from app.schemas.navigation import (
    NavigationRequest, NavigationResponse, Route, RouteStep,
    POISearchRequest, POISearchResponse, PointOfInterest,
    GeocodingRequest, GeocodingResponse, ReverseGeocodingRequest, ReverseGeocodingResponse,
    NavigationUpdate, NavigationAlert, LocationUpdate, LocationHistory,
    TransportMode, POICategory
)
...
async def find_nearby_pois(
    ...
    category: Optional[POICategory] = Query(None, description="POI category filter"),
    query: Optional[str] = Query(None, description="Search query", max_length=100),
...
async def get_navigation_update(
    ...
    try:
        current_location = Coordinates(latitude=lat, longitude=lng)
...
async def get_navigation_alerts(
    ...
    route_id: Optional[UUID] = Query(None, description="Route ID for route-specific alerts"),
    current_user: Optional[User] = Depends(get_current_user_optional)
):
