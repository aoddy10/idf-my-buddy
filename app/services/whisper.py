...
class WhisperService(LoggerMixin):
    ...
    async def transcribe_audio(
        self,
        audio_data: bytes | BinaryIO | Path,
    ...
    async def _prepare_audio_file(self, audio_data: bytes | BinaryIO | Path) -> Path:
    ...
    async def detect_language(self, audio_data: bytes | BinaryIO | Path) -> str:
